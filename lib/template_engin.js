...
(function(exports, global) {
     ...
     */
    exports.render = function(tpl_code, data) {
        var ret
        try {
            ret = exports.compile(tpl_code)(data);
        } catch (error) {
            console.error(error);
            ret = '模板异常 template_engin:render';
        }
        return ret;
    };
    ...
    var _compile = (function() {
        ...
        exports.prototype = {
            ...
            $escape: function(content) {
                ...
                return typeof content === 'string' ? content.replace(/&(?![\w#]+;)|[<>"']/g,
                    function(s) {
                        return {
                            "<": "&#60;",
                            ">": "&#62;",
